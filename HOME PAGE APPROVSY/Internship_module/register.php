...
<div class="container-fluid p-2 d-flex justify-content-center">
	<div class="card" style="border-radius: 19px; width:40rem; height:35rem; ">
		<div class="card-header" style="background-color: #ffffff; border-radius: 19px 19px 0px 0px; background-color: #222; border-radius: 19px 19px 0px 0px; ">
			<h3 class="h3-responsive p-2 text-center text-white" style="margin-top:15px; font-family: 'Quicksand', sans-serif;font-size:30px; font-weight:bold ;">Student Registration Form</h3>
		</div>
		<div class="card-body">
