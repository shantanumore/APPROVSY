	      ...
	      <!-- Collapsible content -->
	        ...
	        <!-- Links -->
		        <ul class="navbar-nav mr-auto smooth-scroll">
          			<li class="nav-item">
            			<a class="nav-link" href="myaccount.php?edit_account" style="font-size:19px;">Edit Account</a>
          			</li>
          			<li class="nav-item">
            			<a class="nav-link" href="myaccount.php?change_password" style="font-size:19px;" >Change Password</a>
          			</li>
          			<li class="nav-item">
            			<a class="nav-link" href="myaccount.php?delete_account" style="font-size:19px;" >Delete Account</a>
          			</li>
		        </ul>
	    	</div>
						...
						"
							<div class='card' >
								<div class='card-header'>
									<h3 class='h3-responsive p-2' style=' font-family: Quicksand, sans-serif;font-size:30px; font-weight:bold ;'><b>Hello $cus_name !</b></h3>
								</div>
