...
$email_id=$_POST['email_id'];
    ...
    header('location:/APPROVSY/HOME PAGE APPROVSY/Project_module/facultyPages/homePage.php');
    } 
    else
    {
echo"invalid";
            ...
            <div class="login-container">
                <div class="signup-content">
                    ...
                    <p style='text-align: center;color: black;'>
                        Don't have account ? <a href="/APPROVSY/HOME PAGE APPROVSY/Project_module/facultyRegistration.php" class="loginhere-link">Register here</a>
                    </p>
                </div>
            </div>
        </section>
