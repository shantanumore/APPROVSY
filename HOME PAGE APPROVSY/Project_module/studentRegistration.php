...
//	$res=$mysqli->query($s);
	...
	while($row=mysqli_fetch_array($res))
	{
		...
		if($numberOfStudents==4)
		{
			...
			else header("location:/APPROVSY/HOME PAGE APPROVSY/Project_module/phpmailer/sendEmail.php");
		}
		...
		if($numberOfStudents==2)
		{
			...
			if($error==TRUE)
			{
				...
				header("location:/APPROVSY/HOME PAGE APPROVSY/Project_module/phpmailer/sendEmail.php");
				//header("location:emailVerification.html");
			}
		}
