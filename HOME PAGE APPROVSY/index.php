        ...
        <div id="preloader">
            <div id="ctn-preloader" class="ctn-preloader">
                ...
                <div class="animation-preloader">
                    <img src="assets/images/svvvlogo.png" class="center" >
                    <!-- Spinner -->
                    <div class="spinner"></p> </div>
                    
                    <!-- Start: Text Loading -->
                    <div class="txt-loading">
                        <span data-text-preloader="&lt" class="letters-loading">&lt</span>
                        ...
                        <span data-text-preloader="&gt" class="letters-loading">&gt</span>
                    </div>
                    <!-- End: Text Loading -->
    ...
    <header class="foi-header landing-header">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light foi-navbar">
                ...
                <h1 style="padding-left: 8in; color: aliceblue;"> &ltAPPROVSY&gt </h1> 
            </nav>
            <div class="header-content">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="assets/images/management.png" alt="app" width="300px" class="img-fluid">
                    </div>
                    <div class="col-md-3" >
                        <a style="margin-bottom: 50px; margin-top: 50px;" href="projectFront.php" class="btn btn-danger btn-lg" >PROJECT MANAGEMENT</a>

                        <a href="Internship_module\index.php" class="btn btn-danger btn-lg" >INTERNSHIP INFORMATION</a>
                    </div>
